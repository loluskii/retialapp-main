  ...
  return (
    <>
      <div className="homeShop logged">
        <h1 style={{ color: "white" }}>Jackpot BetList</h1>
      </div>
                        ...
                        {loading ? (
                          ...
                          bets.map((bet, i) => (
                            <tr className="dgItemStyle" key={bet.betslip_id}>
                              ...
                              <td className="btnsec codcoupon">{bet.title}</td>
                              <td align="center">{formatNumber(bet.amount)}</td>
                              <td className="center">
                                <NavLink
                                  title="Dislpay Betslip"
                                  to={`/Account/BetDetail/${bet.betslip_id}`}
                                >
                                  {bet.betslip_id}
                                </NavLink>
                              </td>
