...
export const TransactionList = () => {
    ...
    return (
        <>
            <div className="homeShop logged" style={{ marginBottom: '15px' }}>
                <input type="button"
                    ...
                    <div className="CntSX">
                        <div className="CntDX">
                            <div className="transactionList">
                                ...
                                <table id="tblSearch2" className="SearchContainerStyle RiepilogoMovimenti" style={{ backgroundColor:'white' }}>
                                    <tbody>
                                    <tr className="SearchSectionStyle">
                                        <td className="SearchDescStyle">
